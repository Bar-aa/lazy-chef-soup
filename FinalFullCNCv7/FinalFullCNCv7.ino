...
const int centerBoxPositionslower[] = {-250,550}; // Horizontal positions
...
void mixSteps(const Soup& selectedSoup){
  ...
  moveToSpicePosition(shelf, box);
  startgripperingSequence(true);
  moveBothMotors(183750,true);
  centerLeftElevated(box,false);
  moveBothMotors(112000,false);
